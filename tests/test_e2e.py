...
class SeleniumTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        options.binary_location = r"C:\Users\qinguo\AppData\Local\Google\Chrome\Application\chrome.exe"
