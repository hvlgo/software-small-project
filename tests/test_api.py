...
class APITestCase(unittest.TestCase):
    ...
    def test_register(self):
        ...
        """
        data = {'username': 'abcdef12', 'password': 'abcdef12ABDC-', 'nickname': 'ladf',
                'mobile': '+86.123456789123', 'url': 'http://qinguo.com', 'magic_number': '1'}
        ...
        log_in_info = {'username': 'abcdef12', 'password': 'abcdef12ABDC-'}
        response = current_app.test_client().patch(
            url_for('user.login'),
            json=log_in_info
        )
